...
const rides = [
  ...
  },
  {
    ...
    rider_id: "66666666-6666-6666-6666-666666666666",
    driver_id: null,
    pickup_lat: 10.775,
    pickup_lng: 106.705,
    dropoff_lat: 10.782,
...
rideHistory.forEach((entry) => {
  rideDb.ride_status_history.updateOne(
    { _id: entry._id },
    { $set: entry },
    { upsert: true }
  );
...
notifications.forEach((notification) => {
  notificationDb.notifications.updateOne(
...
preferences.forEach((pref) => {
  notificationDb.notification_preferences.updateOne(
    { userId: pref.userId },
    { $set: pref },
    { upsert: true }
  );
