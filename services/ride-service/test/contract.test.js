...
function loadSpec() {
  const specPath = path.resolve(__dirname, '../../../contracts/openapi/ride-service.yaml');
...
describe('ride-service contract', () => {
  ...
  it('POST /v1/rides matches contract schema', async () => {
    const spec = loadSpec();
    const responseSchema = resolveSchema(spec, spec.paths['/v1/rides'].post.responses['201'].content['application/json'].schema);
  ...
  it('GET /v1/rides/{id} matches contract schema', async () => {
    const spec = loadSpec();
    const responseSchema = resolveSchema(spec, spec.paths['/v1/rides/{id}'].get.responses['200'].content['application/json'].schema);
