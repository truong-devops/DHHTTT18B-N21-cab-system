...
type ListRidesQuery = NonNullable<paths['/v1/rides']['get']['parameters']['query']>;
...
export async function listRides(query: ListRidesQuery, options: FetchOptions): Promise<RideListResponse> {
