...
function Monitoring() {
  ...
  const load = useCallback(async () => {
    const [nextCounters, nextMarkers] = await Promise.all([monitoringService.getCounters(), monitoringService.getMapSnapshot()]);
  ...
  return (
    <div>
      <PageHeader title="Giám sát" subtitle="Nhịp thở thời gian thực của điều phối, cung ứng và nhu cầu hành khách." />
